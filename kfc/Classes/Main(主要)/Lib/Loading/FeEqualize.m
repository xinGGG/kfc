...
#define kFe_Equalize_Width 150.0f
...
-(void) initCommon
{
    ...
    self.backgroundColor = [UIColor colorWithHexCode:@"#a6a6a6"];
}
...
//        _containerLayer.position = CGPointMake(100, self.bounds.size.height / 2);
...
-(void) initBars
{
    ...
    CGFloat marginX = (MainW - 100)*0.5;

    for (NSInteger i = 0; i < 5 ; i++)
    {
        CGFloat barX = kFe_Equalize_Bar_Width*i;
        CGPoint origin = CGPointMake(kFe_Equalize_Bar_Width * i, 0);
        if (i == 0)
        {
            
            _firstBar = [CAShapeLayer layer];
            _firstBar.frame = CGRectMake(barX, origin.y, kFe_Equalize_Width, kFe_Equalize_Width);
        ...
        if (i == 1)
        {
            ...
            _secondBar.frame = CGRectMake(barX, origin.y, kFe_Equalize_Bar_Width, kFe_Equalize_Bar_Height);
        ...
        if (i == 2)
        {
            ...
            _thirdBar.frame = CGRectMake(barX, origin.y, kFe_Equalize_Bar_Width, kFe_Equalize_Bar_Height);
        ...
        if (i == 3)
        {
            ...
            _fourthBar.frame = CGRectMake(barX, origin.y, kFe_Equalize_Bar_Width, kFe_Equalize_Bar_Height);
        ...
        if (i == 4)
        {
            ...
            _fifthBar.frame = CGRectMake(barX, origin.y, kFe_Equalize_Bar_Width, kFe_Equalize_Bar_Height);
